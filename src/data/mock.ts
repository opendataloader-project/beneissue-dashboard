...
const monthlyTrendData: MonthlyData[] = [
  { month: '2025-07', issuesProcessed: 165, costSavings: 875000, timeSavedHours: 20, roi: 880 },
  { month: '2025-08', issuesProcessed: 152, costSavings: 810000, timeSavedHours: 18, roi: 850 },
  { month: '2025-09', issuesProcessed: 138, costSavings: 735000, timeSavedHours: 17, roi: 820 },
  { month: '2025-10', issuesProcessed: 124, costSavings: 660000, timeSavedHours: 15, roi: 790 },
  { month: '2025-11', issuesProcessed: 110, costSavings: 585000, timeSavedHours: 13, roi: 760 },
  { month: '2025-12', issuesProcessed: 185, costSavings: 985000, timeSavedHours: 22, roi: 920 },
];

// Fixed daily trend data for the past 14 days
const dailyTrendData: DailyData[] = [
  { date: '2025-12-15', triageCount: 12, analyzeCount: 9, fixCount: 4, filteringRate: 28 },
  { date: '2025-12-16', triageCount: 10, analyzeCount: 8, fixCount: 3, filteringRate: 25 },
  { date: '2025-12-17', triageCount: 14, analyzeCount: 10, fixCount: 4, filteringRate: 30 },
  { date: '2025-12-18', triageCount: 9, analyzeCount: 7, fixCount: 3, filteringRate: 22 },
  { date: '2025-12-19', triageCount: 15, analyzeCount: 11, fixCount: 5, filteringRate: 32 },
  { date: '2025-12-20', triageCount: 11, analyzeCount: 8, fixCount: 3, filteringRate: 26 },
  { date: '2025-12-21', triageCount: 8, analyzeCount: 6, fixCount: 2, filteringRate: 20 },
  { date: '2025-12-22', triageCount: 10, analyzeCount: 7, fixCount: 3, filteringRate: 24 },
  { date: '2025-12-23', triageCount: 13, analyzeCount: 9, fixCount: 4, filteringRate: 29 },
  { date: '2025-12-24', triageCount: 8, analyzeCount: 6, fixCount: 2, filteringRate: 21 },
  { date: '2025-12-25', triageCount: 7, analyzeCount: 5, fixCount: 2, filteringRate: 18 },
  { date: '2025-12-26', triageCount: 14, analyzeCount: 10, fixCount: 4, filteringRate: 31 },
  { date: '2025-12-27', triageCount: 16, analyzeCount: 11, fixCount: 5, filteringRate: 33 },
  { date: '2025-12-28', triageCount: 17, analyzeCount: 12, fixCount: 5, filteringRate: 35 },
];
...
export const mockDashboardMetrics: DashboardMetrics = {
  ...
  totalIssuesDelta: Math.round(((latestMonth.issuesProcessed - previousMonth.issuesProcessed) / previousMonth.issuesProcessed) * 100),
  autoResolutionRate: 32.5,
